...
@section('content')
                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                <td class="px-4 py-3">
                                    <div class="flex items-center text-sm">
                                        <div>
                                            <p class="font-semibold"><img
                                                    src="{{ asset('storage') }}/{{ $onboarding->image }}"
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center space-x-4 text-sm">
                                        <a href="{{ route('admin.onboarding.edit', ['id'=>$onboarding->id]) }}"
                                        ...
                                        <a href="{{ route('admin.onboarding.delete', ['id'=>$onboarding->id]) }}" 
    ...
    <div class="mt-[134px]">
        <h1 class="text-neutral-50 text-4xl font-black ">ONBOARDING LIST</h1>
        <div>
            <div class="mt-[58px]">
                <div class="md:flex items-center justify-between block">
                    <p class="text-neutral-50 text-2xl font-black flex space-x-3">
                        ...
                        <span
                            class="px-3 py-1.5 bg-neutral-700 rounded-3xl justify-center items-center gap-2 inline-flex  text-white text-sm font-semibold leading-tight">{{ count($onboardings) }}</span>
                    </p>
                        ...
                        @foreach ($onboardings as $onboarding)
                            <tr>
                                <td class="border border-[#FFFFFF33] text-white  px-6 py-4">
                                    <img src="{{ asset('storage/' . $onboarding->image) }}" width="100px" alt="">
                                </td>
                                <td class="border-b border-[#FFFFFF33] text-white px-6 py-4">
                                    {{ date('Y M d', strtotime($onboarding->created_at)) }}</td>
                                <td class=" border-b border-[#FFFFFF33] text-white px-6 py-4">
                                    <a href="{{ route('admin.onboarding.edit', ['id' => $onboarding->id]) }}">
                                ...
                                <td class="border-b border-[#FFFFFF33] px-6 py-4">
                                    <a href="{{ route('admin.onboarding.delete', $onboarding->id) }}">
